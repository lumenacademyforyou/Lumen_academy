...
/**
 * NOTE:
 * These functions still use the legacy `user_tasks` table.
 *
 * Your current database does NOT contain public.user_tasks.
 * The new canonical task system is learn.plan_task.
 *
 * We are leaving these unchanged temporarily so the profile
 * migration remains isolated.
 */
...
/**
 * NOTE:
 * These functions still use the legacy `user_notes` table.
 *
 * Your current database does NOT contain public.user_notes.
 * We will migrate this separately once the intended canonical
 * notes model is confirmed.
 */
