...
import { INITIAL_ATTEMPTS } from "../database_sample/initialAttempts";
...
const LobbyView = lazy(() => import("./components/views/LobbyView"));
const TestTakingView = lazy(() => import("./components/views/TestTakingView"));
const EvaluatingView = lazy(() => import("./components/views/EvaluatingView"));
const TestListView = lazy(() => import("./components/views/TestListView"));
const SystemCheckView = lazy(() => import("./components/views/SystemCheckView"));
const LandingView = lazy(() => import("./components/views/LandingView"));
const CourseAreaView = lazy(() => import("./components/views/CourseAreaView"));
...
const [userId, setUserId] = useState<string | null>(null);
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      const { exportAnalyticsPdf } = await import("./lib/pdfExport");
